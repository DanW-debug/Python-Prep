...
# Open file
file_handle = open('clase09_ej3a.csv', 'w')
...
# Write the header
file_handle.write(keystr +'\n')

# Building the line and writing to the file
for key in montañas:
    valuelist = montañas.get(key)
    valuestr = str()
